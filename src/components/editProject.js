...
class EditProject extends Component {
    ...
    handleClickIosSwitch = () => {
        let isLive = !this.state.project.isLive;
        let project = { ...this.state.project };
        project.isLive = isLive;
    ...
    handleSubmit = async (e) => {
        e.preventDefault();
        const { isLive, liveurl, title, description, productStory, why, targetUsers, message, github, behance } = this.state.project;
        ...
        try {
            await updateProject(project, this.props.location.state._id);
    ...
    handleChange = ({ currentTarget }) => {
        let project = { ...this.state.project };
        project[currentTarget.name] = currentTarget.value;
        this.setState({ project});
...
componentDidMount() {
    ...
    render() {
        ...
        let { isLive, liveurl, title, description, productStory, why, targetUsers, github, behance, message } = this.state.project;
                      ...
                      Product Template
                        ...
                        <form onSubmit={this.handleSubmit} className={classes.form} noValidate style={{ marginTop: "5%" }}>
                            <Grid container spacing={2}>
                                <Grid xs={12}>
                                    <IosSwitch onClick={this.handleClickIosSwitch} defaultVal={this.props.location.state.isLive} />
                                </Grid>
